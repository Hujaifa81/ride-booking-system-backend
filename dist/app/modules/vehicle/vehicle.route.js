...
router.get("/my-vehicles", (0, checkAuth_1.checkAuth)(user_interface_1.Role.DRIVER), vehicle_controller_1.vehicleController.getMyVehicles);
router.patch("/active-status-change/:vehicleId", (0, checkAuth_1.checkAuth)(user_interface_1.Role.DRIVER), vehicle_controller_1.vehicleController.activeVehicleStatusChange);
